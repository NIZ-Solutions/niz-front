...
export default function Footer() {
  return (
    <footer className="flex w-full flex-col items-center justify-between bg-gray-000 px-10 pb-24 pt-16 shadow-lg">
      <div className="flex w-full max-w-screen-lg flex-col justify-between gap-10">
        {/* 팀 */}
