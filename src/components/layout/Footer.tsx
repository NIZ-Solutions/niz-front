...
export default function Footer() {
  return (
    <footer className="flex w-full flex-col items-start justify-between bg-gray-000 px-10 pb-24 pt-16 shadow-lg dark:bg-black-001">
      <div className="flex max-w-screen-lg flex-col justify-between gap-10">
        {/* 팀 */}
        <div className="team-container flex flex-col gap-[10px]">
          <p className="font-semibold text-gray-003 dark:text-gray-001">팀</p>
        ...
        <div className="agent-container flex flex-col gap-[10px]">
          <p className="font-semibold text-gray-003 dark:text-gray-001">
            고객센터
          </p>
