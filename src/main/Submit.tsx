export default function Submit() {
  return (
    <div className="flex w-full max-w-screen-xl flex-col items-center gap-10 px-5 pb-[180px] pt-[180px] text-center">
      ...
      <form className="submit flex w-full min-w-[330px] flex-col gap-4">
        <div className="content-center rounded-xl p-[2px] main-gradient">
          <div className="rounded-[9px] bg-white-000 p-4">
            <textarea
              className="min-h-[115px] w-full bg-transparent placeholder:text-sm placeholder:text-gray-001"
