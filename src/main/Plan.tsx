  ...
  return (
    <div className="flex h-fit w-full snap-start snap-always flex-col items-center gap-12 px-8 py-[150px] text-center">
      ...
      <ul className="flex w-full max-w-screen-lg flex-col gap-6 text-[15px] text-gray-002">
        <li className="relative flex flex-col gap-3 rounded-lg border border-white/10 bg-black/20 p-[25px] pt-[20px] text-left shadow-lg ring-1 ring-black/5 backdrop-blur-3xl backdrop-saturate-150 supports-[backdrop-filter]:backdrop-blur-3xl">
          <h2 className="text-xl font-extrabold text-blue-001">
            기존 디자인&nbsp;
            <p className="inline font-normal text-gray-001">사용</p>
          </h2>
          <h2 className="text-2xl font-bold text-gray-001">4,900 원</h2>
          ...
          <button
            ...
            className="absolute bottom-[25px] right-[25px] flex h-fit max-w-fit flex-col gap-3 rounded-lg border border-white/10 bg-black/30 px-7 py-2 text-left font-bold text-gray-001 shadow-lg ring-1 ring-black/5 backdrop-blur-md backdrop-saturate-150 supports-[backdrop-filter]:backdrop-blur-md"
          >
            선택
          </button>
        </li>
        <li className="relative flex flex-col gap-3 rounded-lg border border-white/10 bg-black/20 p-[25px] pt-[20px] text-left shadow-lg ring-1 ring-black/5 backdrop-blur-3xl backdrop-saturate-150 supports-[backdrop-filter]:backdrop-blur-3xl">
          <h2 className="text-xl font-bold text-blue-001">
            맞춤형 디자인&nbsp;
            <p className="inline text-gray-001">사용</p>
          </h2>
          <h2 className="text-2xl font-bold text-gray-001">49,900 원</h2>
          <p className="leading-[25px]">
            아이디어에 맞춰 상담 진행 후 <br />
